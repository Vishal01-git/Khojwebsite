    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          ...
          <Title>
            <span id="find">Find</span> <span id="ur">Your</span> <br />
            <span id="real">Real</span>
            <span id="you"> You</span>
          </Title>
          <SubText>
            We are in the mission to find and nurture the young talents within
            them by shaping and giving the right direction to excel.
          </SubText>
          <CTA>
            Know more &nbsp;
